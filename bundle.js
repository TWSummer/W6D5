...
var Root = function (_React$Component) {
  ...
  _createClass(Root, [{
    ...
    value: function render() {
      var tabs = { "one": "stuff", "two": "moar stuff",
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "span",
            null,
            this.zeroPad(time.getHours()) + ":" + this.zeroPad(time.getMinutes()) + ":" + this.zeroPad(time.getSeconds())
          )
        ),
        _react2.default.createElement(
          "div",
          ...
          _react2.default.createElement(
            "span",
            null,
            time.getFullYear() + "-" + this.zeroPad(time.getMonth() + 1) + "-" + this.zeroPad(time.getDate())
          )
        )
      );
    }
...
var Tabs = function (_React$Component) {
  ...
  function Tabs(props) {
    ...
    _this.state = { openedTab: Object.keys(props.tabs)[0] };
    return _this;
  }
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "tabs" },
        Object.keys(tabs).map(function (tabName) {
          return _react2.default.createElement(_tab2.default, { tabName: tabName, tabDescription: tabs[tabName], selectedTab: _this2.state.openedTab });
        })
      );
    }
  }]);
